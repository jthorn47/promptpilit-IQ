...
CREATE POLICY "Company admins can insert disbursement instructions" 
ON public.disbursement_instructions 
FOR INSERT 
WITH CHECK (EXISTS (
  SELECT 1 FROM public.disbursement_batches db 
...
CREATE POLICY "Company admins can update disbursement instructions" 
ON public.disbursement_instructions 
FOR UPDATE 
USING (EXISTS (
  SELECT 1 FROM public.disbursement_batches db 
...
CREATE POLICY "Company admins can delete disbursement instructions" 
ON public.disbursement_instructions 
FOR DELETE 
USING (EXISTS (
  SELECT 1 FROM public.disbursement_batches db 

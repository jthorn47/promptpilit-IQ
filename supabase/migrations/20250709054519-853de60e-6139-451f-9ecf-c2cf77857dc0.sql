...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_company_settings_name_search 
ON public.company_settings USING gin(to_tsvector('english', company_name));

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_company_settings_status 
ON public.company_settings (subscription_status);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_company_settings_created_at 
ON public.company_settings (created_at DESC);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_invitations_search 
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_invitations_invited_at 

...
-- Update the create_test_account function to work with pgcrypto
...
BEGIN
  ...
  IF new_user_id IS NOT NULL THEN
    -- User exists, just ensure role is set up
  ...
  -- Insert directly into auth.users with confirmed email (bypassing password validation)
  INSERT INTO auth.users (
    ...
    'authenticated',
    user_email,
    crypt(user_password, gen_salt('bf')),  -- Now this should work with pgcrypto enabled

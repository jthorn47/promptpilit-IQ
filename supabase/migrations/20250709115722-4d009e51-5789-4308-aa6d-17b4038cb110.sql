...
-- Insert default document types with explicit array casting
INSERT INTO public.document_types (name, description, category, compliance_framework, legal_disclaimer) VALUES
('Workplace Violence Prevention Plan', 'Comprehensive plan for preventing workplace violence as required by SB 553', 'wpv', ARRAY['SB 553', 'Cal/OSHA']::TEXT[], 'This plan is provided for compliance assistance only and does not constitute legal advice. Consult with legal counsel for specific requirements.'),
('Injury and Illness Prevention Program', 'IIPP as required by Cal/OSHA', 'iipp', ARRAY['Cal/OSHA', 'OSHA']::TEXT[], 'This program template is provided for compliance assistance only. Employers must customize this program to reflect their specific workplace conditions.'),
('Employee Handbook', 'Comprehensive employee handbook covering policies and procedures', 'handbook', ARRAY[]::TEXT[], 'This handbook template provides general guidance and must be customized to reflect your specific workplace policies and applicable laws.'),
('HR Policy Manual', 'Human resources policies and procedures', 'hr_policy', ARRAY[]::TEXT[], 'These policy templates are provided for informational purposes and must be reviewed by legal counsel before implementation.'),
('Safety Manual', 'Workplace safety policies and procedures', 'safety', ARRAY['OSHA', 'Cal/OSHA']::TEXT[], 'This safety manual template must be customized to reflect your specific workplace hazards and safety requirements.');
...
('Non-Discrimination Clause', 'This company is an equal opportunity employer and does not discriminate on the basis of race, color, religion, gender, sexual orientation, gender identity, national origin, age, disability, or any other legally protected status.', 'policy', ARRAY['handbook', 'hr_policy']::TEXT[], 'US'),
('At-Will Employment', 'Employment with this company is at-will, meaning that either the employee or the company may terminate the employment relationship at any time, with or without cause or notice.', 'policy', ARRAY['handbook']::TEXT[], 'US'),
('Confidentiality Agreement', 'Employees must maintain the confidentiality of proprietary information and trade secrets of the company and its clients.', 'policy', ARRAY['handbook', 'hr_policy']::TEXT[], 'US'),
('Safety Compliance', 'All employees are required to comply with safety policies and procedures and report any unsafe conditions immediately.', 'policy', ARRAY['safety', 'iipp']::TEXT[], 'US'),
('Cal/OSHA Disclaimer', 'This document has been prepared to assist employers in complying with Cal/OSHA requirements. It does not constitute legal advice and should be reviewed by qualified professionals.', 'disclaimer', ARRAY['iipp', 'safety', 'wpv']::TEXT[], 'CA');
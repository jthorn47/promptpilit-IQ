-- Fix duplicate key constraint violation in create_super_admin_user function
-- Remove manual profile creation since the trigger handles it automatically
...
BEGIN
  ...
  -- Create super_admin role (profile is created automatically by trigger)

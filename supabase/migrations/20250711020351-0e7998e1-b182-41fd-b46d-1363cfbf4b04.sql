...
BEGIN
    ...
    FOR client_rec IN 
        ...
        WHERE c.company_settings_id IS NULL
        ORDER BY c.date_won DESC
    LOOP
        -- Create or find matching company_settings record
        SELECT cs.id INTO target_company_id 
        FROM public.company_settings cs
        WHERE cs.company_name ILIKE client_rec.company_name 
        LIMIT 1;

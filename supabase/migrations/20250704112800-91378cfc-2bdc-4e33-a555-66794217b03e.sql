-- Create some sample training modules (without the training data for now)
...
-- Create training assignments and some completions with unique certificate numbers
DO $$
DECLARE
    module_rec RECORD;
    employee_rec RECORD;
            ...
            IF NOT EXISTS (
                ...
                IF random() < 0.7 THEN
                    ...
                    IF score >= 80 THEN
                        ...
                        cert_number := 'CERT-' || TO_CHAR(completion_date, 'YYYYMMDD') || '-' || LPAD(cert_counter::TEXT, 6, '0');

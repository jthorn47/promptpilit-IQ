-- Update existing cases with valid types and add realistic closed cases
...
-- Insert additional closed cases for meaningful resolution trends using valid types

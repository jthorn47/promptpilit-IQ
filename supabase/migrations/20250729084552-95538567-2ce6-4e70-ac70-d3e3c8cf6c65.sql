...
-- Insert default widget definitions using only valid app_role values
...
('Task Manager', 'Track and manage tasks and projects', 'Clock', 'TaskWidget', 'productivity', ARRAY['super_admin', 'company_admin', 'admin']::app_role[]),
...
('Calendar & Meetings', 'Schedule and manage meetings and appointments', 'Calendar', 'CalendarWidget', 'productivity', ARRAY['super_admin', 'company_admin', 'admin']::app_role[]),
('Quick Notes', 'Create and manage quick notes and reminders', 'FileText', 'NotesWidget', 'productivity', ARRAY['super_admin', 'company_admin', 'admin']::app_role[]),

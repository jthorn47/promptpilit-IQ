-- Clean up any orphaned test users and create fresh ones
DO $$
DECLARE
...
BEGIN
  -- First, completely clean up any existing test users from all tables
  -- Get user IDs that might exist
  ...
  -- Also clean up by user_id in case there are orphaned profiles
  ...
  RAISE NOTICE 'Successfully created all test users';

-- Update the create_super_admin_user function to handle existing profiles
...
BEGIN
  ...
  IF new_user_id IS NOT NULL THEN
    ...
    WHERE user_id = new_user_id AND role = 'super_admin';
  ...
  -- Create super_admin role (with conflict handling)
  INSERT INTO public.user_roles (user_id, role)
  VALUES (new_user_id, 'super_admin')
  ON CONFLICT (user_id, role) DO NOTHING;

...
-- Add RLS policies for payroll employees  
...
BEGIN
    ...
    LOOP
        ...
        ELSE
            ...
            employee_count := floor(random() * 250 + 5)::INTEGER;
        END IF;
        
        -- Update the company's max_employees to match actual employee count
        UPDATE public.company_settings 
        SET max_employees = employee_count
        WHERE id = client_record.id;
        
        RAISE NOTICE 'Adding % employees to %', employee_count, client_record.company_name;
        ...
        FOR i IN 1..employee_count LOOP
            ...
            INSERT INTO public.employees (
                ...
                CURRENT_DATE - (floor(random() * 1825) || ' days')::INTERVAL, -- Random hire date within last 5 years
                rand_job_title,
                rand_department,
                rand_salary,
                rand_hourly_rate,

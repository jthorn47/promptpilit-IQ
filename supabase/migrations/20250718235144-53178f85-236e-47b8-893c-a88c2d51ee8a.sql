-- Create the correct client module settings table for universal settings schema
DROP TABLE IF EXISTS public.client_module_settings CASCADE;
DROP TABLE IF EXISTS public.client_settings_audit CASCADE;
...
-- Create policies for client_module_settings (FIXED: removed invalid payroll_manager role)

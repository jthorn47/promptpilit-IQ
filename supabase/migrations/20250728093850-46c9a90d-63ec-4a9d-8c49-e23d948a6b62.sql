-- Ultra-simple Pulse CMS seed data that works with current schema
-- Let's just add basic data that can populate the reports
...
-- Insert basic cases with only existing columns

-- Create benefit_enrollments table for tracking employee enrollments
...
-- Enable RLS on benefit_enrollments
ALTER TABLE public.benefit_enrollments ENABLE ROW LEVEL SECURITY;

-- Policy for company admins to manage their benefit enrollments
...
-- Policy for company users to view their benefit enrollments
...
-- Enable RLS on benefit_costs
ALTER TABLE public.benefit_costs ENABLE ROW LEVEL SECURITY;

-- Policy for company admins to manage their benefit costs
...
-- Policy for company users to view their benefit costs

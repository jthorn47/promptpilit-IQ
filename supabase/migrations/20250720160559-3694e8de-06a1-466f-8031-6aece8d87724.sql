-- Insert sample payroll runs for the last few weeks
INSERT INTO public.payroll_runs (id, company_id, pay_period_start, pay_period_end, pay_date, status, created_by, created_at, updated_at) VALUES
(gen_random_uuid(), (SELECT id FROM company_settings LIMIT 1), '2025-01-13', '2025-01-19', '2025-01-24', 'completed', (SELECT id FROM employees LIMIT 1), now(), now()),
(gen_random_uuid(), (SELECT id FROM company_settings LIMIT 1), '2025-01-06', '2025-01-12', '2025-01-17', 'completed', (SELECT id FROM employees LIMIT 1), now(), now()),
(gen_random_uuid(), (SELECT id FROM company_settings LIMIT 1), '2024-12-30', '2025-01-05', '2025-01-10', 'completed', (SELECT id FROM employees LIMIT 1), now(), now());

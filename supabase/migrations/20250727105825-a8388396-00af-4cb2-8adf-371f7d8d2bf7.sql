-- Fix the sync function to match the actual user_profiles table structure
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Create user profile (only using columns that exist)
...
-- Also update the trigger function to match the table structure
...
BEGIN
  ...
  -- Insert user profile (only using columns that exist)

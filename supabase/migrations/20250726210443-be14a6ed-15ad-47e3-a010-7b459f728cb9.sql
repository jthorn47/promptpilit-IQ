...
CREATE INDEX idx_employee_schedules_company ON public.employee_schedules(company_id);
CREATE INDEX idx_attendance_variances_employee ON public.attendance_variances(employee_id);
CREATE INDEX idx_punch_corrections_employee ON public.punch_corrections(employee_id);

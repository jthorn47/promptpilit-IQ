...
-- Replace broad policies with proper role-based access
...
-- Company admins can manage training scenes from training modules they have access to
...
-- Learners can only view training scenes from assigned training modules

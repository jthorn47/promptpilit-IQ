...
-- Add check constraint for valid brands using proper enum syntax
ALTER TABLE public.email_templates 
ADD CONSTRAINT check_valid_brand_identity 
CHECK (brand_identity IN ('easeworks'::brand_identity, 'easelearn'::brand_identity, 'dual'::brand_identity));

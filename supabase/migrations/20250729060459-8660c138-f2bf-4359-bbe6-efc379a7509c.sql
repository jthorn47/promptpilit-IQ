...
-- Step 5: Create brand context management functions
...
BEGIN
  RETURN COALESCE(
    current_setting('app.brand_identity', true)::brand_identity,
    'easeworks'::brand_identity
  );
END;
$$;

-- Step 6: Make brand_identity NOT NULL on email_templates
...
AS $$
BEGIN
  IF OLD.brand_identity != NEW.brand_identity THEN

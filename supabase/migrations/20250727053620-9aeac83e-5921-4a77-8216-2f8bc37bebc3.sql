-- ConnectIQ CRM Schema v3 - Complete Implementation
-- Core CRM tables with proper constraints and RLS policies
...
-- Create the core companies table (CRM version) - drop if exists and recreate
...
CREATE INDEX idx_crm_companies_name ON public.crm_companies USING gin (name gin_trgm_ops);

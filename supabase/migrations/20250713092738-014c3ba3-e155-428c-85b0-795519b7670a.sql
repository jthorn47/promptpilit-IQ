...
SELECT 
    ...
    (SELECT id FROM deal_stages WHERE name = 'Demo' LIMIT 1), 50, '2025-08-15', 'open', 'website'
...
SELECT 
    ...
    (SELECT id FROM deal_stages WHERE name = 'Proposal' LIMIT 1), 75, '2025-07-30', 'open', 'referral'
...
SELECT 
    ...
    (SELECT id FROM deal_stages WHERE name = 'Discovery' LIMIT 1), 25, '2025-09-01', 'open', 'website'

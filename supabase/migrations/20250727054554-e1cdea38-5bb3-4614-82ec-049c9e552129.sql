-- Create RLS policies for tables that need them (using IF NOT EXISTS would be ideal but not supported)

-- Check which policies exist and create missing ones for crm_spin_contents
DO $$
BEGIN
    IF NOT EXISTS (
